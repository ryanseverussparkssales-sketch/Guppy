...
def rotate_jsonl_file(path: Path, max_bytes: int | None = None, keep_files: int | None = None):
...
def log_session_event(source: str, event: str, level: str = "info", session_id: str = "", **fields):
    payload = {
