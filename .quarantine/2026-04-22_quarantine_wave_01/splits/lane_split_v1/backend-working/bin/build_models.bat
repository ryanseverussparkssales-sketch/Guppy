...
ollama create guppy-fast -f config\local_llm\modelfiles\Modelfile.guppy-fast
...
ollama create vault-scraper -f config\local_llm\modelfiles\Modelfile.vault-scraper
...
ollama create merlin-code -f config\local_llm\modelfiles\Modelfile.merlin-code
