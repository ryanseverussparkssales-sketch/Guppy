...
**Status:** ðŸŸ¢ **LOCKED** â€” Approved for M2 implementation
...
**Three Major Changes:**
1. **Home Tab = Primary Surface** (70%+ screen focus) â€” active instance chat
2. **Multi-Instance Architecture** â€” one primary active instance plus one background collaborator in M2.0, with inter-agent communication
3. **Tool Separation** â€” Agent Tools (for instances) vs App Management (for app operations)
...
### Home Tab (Primary)
```
[Instance: Guppy â–¼] [Switch â–¼]
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  70% height
â”‚                                                         â”‚
â”‚  [User Message]                                         â”‚
...
â”‚ Name      â”‚ Status   â”‚ Last Message â”‚ Actions        â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ Guppy     â”‚ Active   â”‚ "Sure, I'll..." â”‚ [Switch] ... â”‚
â”‚ Builder   â”‚ Running  â”‚ "Schema saved"  â”‚ [Logs] ...   â”‚
â”‚ Merlin    â”‚ Idle     â”‚ "Ready"         â”‚ [Delete] ... â”‚
...
```
Agent Tools for: [Guppy â–¼]

[Search: find a tool...]  [All â–¼] [Read-Only] [Write] [Query]

â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ run_python   â”‚ read_file    â”‚ write_file   â”‚
â”‚ âœ“ Ready      â”‚ âœ“ Ready      â”‚ âœ“ Ready      â”‚
â”‚ Execute code â”‚ Read text    â”‚ Write text   â”‚
â”‚ [Run]        â”‚ [Run]        â”‚ [Run]        â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜

â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ query_instanceâ”‚screenshot   â”‚write_json    â”‚
â”‚ âœ“ Ready      â”‚ âœ“ Ready      â”‚ âœ“ Ready      â”‚
â”‚ Query other  â”‚ Screen cap   â”‚ Write JSON   â”‚
â”‚ instances    â”‚ [Run]        â”‚ [Run]        â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
```
...
â”‚ [Warmup]                     â”‚
â”‚ Refresh model cache          â”‚
â”‚ [Execute]                    â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜

System Health
â”œâ”€ Status: Healthy
â”œâ”€ Models Loaded: 5/5
â”œâ”€ Instances Running: 2
â””â”€ Uptime: 14:23

Recent Events (Last 5)
â”œâ”€ 14:22 Model warmup complete
â”œâ”€ 14:20 Instance 'Builder' created
â”œâ”€ 14:18 Model 'guppy-teach' loaded
â”œâ”€ 14:15 Launcher started
â””â”€ 14:10 API health check OK
```
...
**Constraint:** Home tab MUST occupy â‰¥70% of window height on 1920x1080 resolution.  
...
â†’ { "response": "...", "tokens_used": 42, "model": "guppy-teach", "source_instance": "builder", "status": "ok|busy|timeout" }
```
...
**UI Pattern:**
```
[Instance: Guppy â–¼] [Switch to Instance Manager â–¼]
```
...
â†’ active instance (Merlin) invokes tool: query_instance("Guppy", "Summarize the API docs")

guppy_api.py endpoint: POST /instances/Guppy/query
Payload: { "message": "Summarize the API docs" }

â†’ Background Guppy instance processes message immediately if idle

â† Response: { "response": "The API...", "tokens_used": 78, "model": "guppy", "duration_ms": 2100, "source_instance": "Guppy", "status": "ok" }

â†’ Result appears in active instance chat: "[From Guppy]: The API..."
```
...
### Week 1: Instance Manager Foundation (Apr 15â€“19)
...
### Week 2: Home Tab Primary + Switching (Apr 22â€“26)
...
### Week 3: Agent Tools Separation (Apr 29â€“May 3)
- [ ] Extract tool list from existing Tools tab
- [ ] Implement permissions system (instance type â†’ tool visibility)
- [ ] Create Agent Tools tab layout
- [ ] Create App Management tab layout

### Week 4: API & Multi-Instance Support (May 6â€“10)
...
- [ ] Test inter-agent query (Merlin â†’ Guppy â†’ Merlin)

### Week 5: Integration & Polish (May 13â€“17)
...
### Week 6â€“8: Refinement + Other Epics (May 20â€“Jun 14)
...
- [ ] Home tab takes â‰¥70% of window on standard resolution
...
**New Files:**
- `ui/launcher/views/instance_manager_view.py` â€” Instance Manager UI
- `ui/launcher/components/instance_editor_modal.py` â€” Create instance form
- `ui/launcher/views/agent_tools_view.py` â€” Agent Tools tab
- `ui/launcher/views/app_management_view.py` â€” App Management tab (formerly Advanced)
- `utils/instance_logger.py` â€” Per-instance chat logging
- `config/instances.json` â€” Instance definitions
- `config/tool_permissions.json` â€” Tool permission matrix

**Modified Files:**
- `ui/launcher/launcher_window.py` â€” Tab reorganization, instance switching
- `ui/launcher/views/assistant_view.py` â€” Home tab layout (70% focus)
- `guppy_api.py` â€” Add `/instances/{name}/query` endpoint
- `guppy_core/tool_registry.py` â€” Add `query_instance` tool
- `guppy_core/tool_runner.py` â€” Add per-instance capability enforcement for tool execution

**Removed:** (none, Advanced tab codeâ†’App Management, not deleted)

---

## Backward Compatibility

âœ… **All existing single-instance chat flows work unchanged.**  
âœ… **Existing tool invocations can be migrated incrementally by mapping default capability sets to the current single-instance flow.**  
âœ… **API endpoints remain the same; new endpoints additive only.**
...
## EOF â€” M2 UI ARCHITECTURE REFINED
